 ...
 */ (() => {
    ...
    const H =
        `<style nonce="${nonce}">.asw-rg{position:fixed;top:0;left:0;right:0;width:100%;height:0;pointer-events:none;background-color:rgba(0,0,0,.8);z-index:1000000} .asw-rg-bottom{top:auto;bottom:0}</style> <div class="asw-rg asw-rg-top"></div> <div class="asw-rg asw-rg-bottom"></div>`;
    var z = function () {
            return (
                (z =
                    Object.assign ||
    ...
    styleI.setAttribute('nonce', nonce);
    styleI.textContent = `.asw-menu,.asw-widget{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-weight:400;-webkit-font-smoothing:antialiased}
                        .asw-menu *,.asw-widget *{box-sizing:border-box!important}
                        .asw-menu-btn{position:fixed;z-index:500000;right:30px;bottom:30px;box-shadow:0 5px 15px 0 rgb(37 44 97 / 15%),0 2px 4px 0 rgb(93 100 148 / 20%);transition:transform .2s ease;border-radius:50%;align-items:center;justify-content:center;width:58px;height:58px;display:flex;cursor:pointer;border:3px solid #fff!important;outline:5px solid #0048ff!important;text-decoration:none!important;background:#326cff!important;background:linear-gradient(96deg,#326cff 0,#0048ff 100%)!important}
                        .asw-menu-btn svg{width:36px;height:36px;min-height:36px;min-width:36px;max-width:36px;max-height:36px;background:0 0!important}
                        .asw-menu-btn:hover{transform:scale(1.05)}
                        @media only screen and (max-width:768px){.asw-menu-btn{width:42px;height:42px}.asw-menu-btn svg{width:26px;height:26px;min-height:26px;min-width:26px;max-width:26px;max-height:26px}}.fill-white{fill: white;}`;
    document.head.appendChild(styleI);    
    const I =
        `<div class="asw-widget"> <a href="https://accessibility-widget.pages.dev" target="_blank" class="asw-menu-btn" title="Open Accessibility Menu" role="button" aria-expanded="false"> <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" viewBox="0 0 24 24" width="30px" height="30px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20.5 6c-2.61.7-5.67 1-8.5 1s-5.89-.3-8.5-1L3 8c1.86.5 4 .83 6 1v13h2v-6h2v6h2V9c2-.17 4.14-.5 6-1l-.5-2zM12 6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/></svg> </a> </div>`;
    ...
    styleG.setAttribute('nonce', nonce);
    styleG.textContent = `.asw-menu { position: fixed; left: 0; top: 0; box-shadow: 0 0 20px #00000080; opacity: 1; transition: .3s; z-index: 500000; overflow: hidden; background: #eff1f5; width: 400px; line-height: 1; font-size: 16px; height: 100%; letter-spacing: .015em; }
.asw-menu * { color: #000 !important; font-family: inherit; padding: 0; margin: 0; line-height: 1 !important; letter-spacing: normal !important; }
.asw-card { margin: 0 15px 20px; }
.asw-card-title { font-size: 14px !important; padding: 15px 0; font-weight: 600 !important; opacity: .8; }
.asw-menu .asw-select { width: 100% !important; padding: 0 15px !important; font-size: 16px !important; font-family: inherit !important; font-weight: 600 !important; border-radius: 45px !important; background: #fff !important; border: none !important; height: 45px !important; color: inherit !important; }
.asw-items { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0.5rem; }
.asw-btn { aspect-ratio: 6/5; border-radius: 12px; padding: 0 10px; display: flex; align-items: center; justify-content: center; flex-direction: column; text-align: center; color: #333; font-size: 14px !important; background: #fff !important; border: 2px solid transparent !important; transition: border-color .2s ease; cursor: pointer; word-break: break-word; gap: 5px; position: relative; width: auto !important; height: auto !important; }
.asw-adjust-font .asw-label div, .asw-btn .asw-translate { font-size: 12px !important; font-weight: 600 !important; }
.asw-minus, .asw-plus { background-color: #eff1f5 !important; border: 2px solid transparent; transition: border .2s ease; }
.asw-minus:hover, .asw-plus:hover { border-color: #0848ca !important; }
.asw-amount { font-size: 16px !important; font-weight: 600 !important; }
.asw-adjust-font svg, .asw-btn svg { width: 28px !important; height: 28px !important; }
.asw-btn.asw-selected, .asw-btn:hover { border-color: #0848ca !important; }
.asw-btn.asw-selected span, .asw-btn.asw-selected svg { fill: #0848ca !important; color: #0848ca !important; }
.asw-btn.asw-selected:after { content: "✓"; position: absolute; top: 10px; right: 10px; background-color: #0848ca !important; color: #fff; padding: 6px; font-size: 10px; width: 18px; height: 18px; border-radius: 100%; }
.asw-menu-content { overflow: scroll; max-height: calc(100% - 80px); padding: 30px 0 15px; }
.asw-adjust-font { background: #fff; padding: 20px; margin-bottom: 20px; }
.asw-adjust-font .asw-label { display: flex; justify-content: flex-start; }
.asw-adjust-font > div { display: flex; justify-content: space-between; margin-top: 20px; align-items: center; font-size: 15px; }
.asw-adjust-font div[role=button] { background: #eff1f5 !important; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; cursor: pointer; }
.asw-overlay { position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 10000; }
@media only screen and (max-width: 560px) { .asw-menu { width: 100%; } }
@media only screen and (max-width: 420px) { .asw-items { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: .5rem; } }
`;
    document.head.appendChild(styleG);    
    const G =
            `<div class="card border asw-menu">
               <div class="card-header d-flex flex-between-center px-4 py-3 border-bottom asw-menu-header">
                    <h5 class="mb-0 d-flex align-items-center gap-2 asw-menu-title asw-translate">Accessibility Menu</h4>
                    <button role="button" class="btn btn-soft-warning p-2 rounded-pill asw-menu-reset" title="Reset settings">
                        <span class="uil uil-refresh me-2"></span>Reset
                    </button>
                    <button role="button" class="btn btn btn-soft-primary p-2 rounded-pill asw-menu-close" title="Close">
                        <span class="uil uil-times"></span>                       
                    </button>
               </div>
               <div class="card-body overflow-x-hidden scrollbar asw-menu-content">
                  ...
                  <div class="asw-card">
                     ...
                     <div class="asw-adjust-font">
                        <div class="asw-label m-0">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="me-3">
                     ...
                     <div class="asw-items textcontent"> </div>
                  </div>
                  <div class="asw-card">
               ...
               <div class="card-footer d-flex justify-content-center gap-2 border-top ps-3 pe-4 py-3 asw-footer"> 
                    <a href="#" target="_blank">Web Accessibility Statement</a> 
                </div>
            </div>
    ...
    function Q(t) {
        ...
        (null == u ? void 0 : u.includes("right")) && ((p.style.right = "0px"), (p.style.left = "auto")),
            (p.querySelector(".textcontent").innerHTML = W(J)),
        ...
        /* uncommnet if language select is open
